...
public class GeographicalMapTest {
	...
	public void setUp() throws Exception {
		mapTest = new GeographicalMap("My Test Map" , new UniqueId(0, 0));
	...
	public void testUnregisterGeoRegion() {
		mapTest.registerGeoRegion(gR);
		mapTest.unregisterGeoRegion(gR.getUniqueId().getId());
	...
	public void testPutRegLinkBetween() {
		...
		assert(rL.getLoc1().equals(gR) && rL.getLoc2().equals(gR2) && gR.getPathById(rL.getUniqueId().getId()).getUniqueId().getId() == 2 && gR2.getPathById(rL.getUniqueId().getId()).getUniqueId().getId() == 2);
	}
	...
	public void testRemoveRegLink() {
		...
		mapTest.registerGeoRegion(gR2);
		mapTest.putRegLinkBetween(rL, gR, gR2);
		mapTest.removeRegionLink(rL.getUniqueId().getId());
		assert(rL.getLoc1() == null && rL.getLoc2() == null && gR.getPathById(rL.getUniqueId().getId()) == null && gR2.getPathById(rL.getUniqueId().getId()) == null);
	}
	...
	public void testLinkARegLinkAndGeoReg() {
		...
		assert(rL2.getLoc1().getName().equals("testLink0") && rL2.getLoc2().getName().equals("test1") && rL.getPathById(rL.getUniqueId().getId()).getName().equals("testLink1") && gR2.getPathById(rL2.getUniqueId().getId()).getName().equals("testLink1"));
	}
	...
	public void testRemoveRegLinkThatIsLinked() {
		...
		assert(rL.getLoc1() == null && rL.getLoc2() == null && gR.getPathById(rL.getUniqueId().getId()) == null && gR2.getPathById(rL.getUniqueId().getId()) == null &&
				rL2.getLoc1() == null && rL2.getLoc2() == null && gR.getPathById(rL2.getUniqueId().getId()) == null && gR2.getPathById(rL2.getUniqueId().getId()) == null);
	}
	...
	public void testAddChildLoc() {
		...
		assert(gR.getChildLocById(gL.getUniqueId().getId()).getName().equals("gR") && gL.getParent() != null && gL.getParent().getName().equals("test0"));
	}
	...
	public void testRemoveChildLoc() {
		...
		assert(gR.getChildLocById(gL.getUniqueId().getId()) == null && gL.getParent() == null);
	}
	...
	public void testRemoveWrongChildLoc() {
		...
		assert(result == null && gR.getChildLocById(gL.getUniqueId().getId()).getName().equals("gL") && gL.getParent().getName().equals("test0"));
	}
	...
	public void testPutLocationLink() {
		...
		assert(lL.getParent().getUniqueId().getId() == gR.getUniqueId().getId() && lL.getLoc1().getUniqueId().getId() == gL.getUniqueId().getId() && lL.getLoc2().getUniqueId().getId() == gL2.getUniqueId().getId() && gL.getPathById(lL.getUniqueId().getId()) != null && gL2.getPathById(lL.getUniqueId().getId()) != null);
	}
	...
	public void testRemoveLocationLink() {
		...
		assert(lL.getParent() == null && lL.getLoc1() == null && lL.getLoc2() == null && gL.getPathById(lL.getUniqueId().getId()) == null && gL2.getPathById(lL.getUniqueId().getId()) == null);
	}
	...
	public void testRemoveWrongChildLocLink() {
		...
		assert(lL.getParent().getUniqueId().getId() == gR.getUniqueId().getId() && lL.getLoc1().getUniqueId().getId() == gL.getUniqueId().getId() && lL.getLoc2().getUniqueId().getId() == gL2.getUniqueId().getId() && gL.getPathById(lL.getUniqueId().getId()) != null && gL2.getPathById(lL.getUniqueId().getId()) != null &&
				lL2.getParent() == null && lL2.getLoc1() == null && lL2.getLoc2() == null && gL.getPathById(lL2.getUniqueId().getId()) == null && gL2.getPathById(lL2.getUniqueId().getId()) == null);
	}
	...
	public void testPutLocationLinkIncorrectly() {
		...
		assert(!result && lL.getParent() == null && lL.getLoc1() == null && lL.getLoc2() == null && gL.getPathById(lL.getUniqueId().getId()) == null && gL2.getPathById(lL.getUniqueId().getId()) == null);
	}
	...
	public void testRemoveRegionWithLinkedChildren() {
		...
		mapTest.unregisterGeoRegion(gR.getUniqueId().getId());
		assert(mapTest.getGeoRegions().size() == 1 && gR.getChildLocById(gL.getUniqueId().getId()) != null &&  gR.getChildLocById(gL2.getUniqueId().getId()) != null && gR.getChildLocById(lL.getUniqueId().getId()) != null && gR.getChildLocById(lL2.getUniqueId().getId()) != null && rL.getChildLocById(gL3.getUniqueId().getId()) != null &&
				rL.getLoc1() == null && rL.getLoc2() == null && gR.getPathById(rL.getUniqueId().getId()) == null && gR2.getPathById(rL.getUniqueId().getId()) == null &&
				lL2.getParent() == null && lL2.getLoc1() == null && lL2.getLoc2() == null && gL2.getPathById(lL2.getUniqueId().getId()) == null && gL3.getPathById(lL2.getUniqueId().getId()) == null);
	}
	...
	private class TestGeographicalRegion extends GeographicalRegion {
		public TestGeographicalRegion(String name, int id, int xCoord, int yCoord) {
			super(name, new UniqueId(id, 1), xCoord, yCoord, new AspectManager());
		}
	}
	...
	private class TestGeographicalLocation extends GeographicalLocation {
		public TestGeographicalLocation(String name, int id, int xCoord, int yCoord) {
			super(name, new UniqueId(id, 2), xCoord, yCoord, new AspectManager(), null);
		}
	}
